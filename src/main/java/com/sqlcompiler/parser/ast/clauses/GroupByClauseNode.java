...
public class GroupByClauseNode extends ASTNode {
    ...
    // Add this constructor after the existing constructors

    public GroupByClauseNode(List<ExpressionNode> expressions) {
        this.groupingElements = new ArrayList<>();
        this.groupingSets = null;

        if (expressions != null) {
            for (ExpressionNode expr : expressions) {
                this.groupingElements.add(new GroupingElement(expr));
            }
        }
    }
    ...
    public GroupByClauseNode(List<GroupingElement> groupingElements,
        ...
        this.groupingElements = groupingElements != null ? new ArrayList<>(groupingElements) : new ArrayList<>();
        this.groupingSets = groupingSets != null ? new ArrayList<>(groupingSets) : new ArrayList<>();
    }
