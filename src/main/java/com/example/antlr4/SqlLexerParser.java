...
public class SqlLexerParser extends Parser {
	...
	public static class GreetingContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(SqlLexerParser.ID, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SqlLexerListener ) ((SqlLexerListener)listener).enterGreeting(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SqlLexerListener ) ((SqlLexerListener)listener).exitGreeting(this);
		}
	}
